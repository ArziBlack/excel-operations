...
#[derive(Debug, Serialize, Deserialize)]
pub struct OilSpillIncident {
    pub incident_oil_spill_ref_no: String,
    pub e_page_code: String,
    pub facility_equipment: String,
    pub facility_category: String,
    pub location: String,
    pub closeby_facility: String,
    pub area: String,
    pub lga: String,
    pub state: String,
    ...
    pub latitude: f64,
    pub longitude: f64,
    pub date_of_incident_spill: String,
    pub date_of_incident_spill_observed: String,
    pub time_of_incident_spill: String,
    pub time_of_incident_spill_observed: String,
    pub date_spill_was_stopped: String,
    pub date_spill_was_contained: String,
    pub time_spill_was_contained: String,
    pub oml_opl: String,
    pub incident_cause_of_spill_or_leakage: String,
    pub incident_type_spill_category: String,
    pub description_of_spill_causes: String,
    pub incident_spill_responsibility: String,
    pub est_qty_spilled: f64,
    pub est_qty_recovered: f64,
    pub tiered_level: String,
    pub date_of_survey: String,
    pub survey_map_ref_no: f64,
    pub survey_cost_ngn_x_1000: f64,
    pub survey_cost_us_eq_x_1000: f64,
    pub nnpc_budget_code: String,
    pub date_of_mobilization: String,
    pub date_of_repair: String,
    pub contract_ref_no_used_for_repair: String,
    pub contractor_name: String,
    pub repair_cost_ngn_x_1000: f64,
    pub repair_cost_us_x_1000: f64,
    pub repair_cost_us_equiv_x_1000: f64,
    pub days_shutin: f64,
    pub est_prod_loss: f64,
    pub loss_due_to_oil_spill_ngn: f64,
    pub loss_due_to_oil_spill_us_equiv: f64,
    pub remarks_cost_involved_in_repairs: String,
    pub completion_status: String,
    pub jiv_date: String,
    pub is_cleanup_required: bool,
    pub date_of_form_a: String,
    pub date_of_form_b: String,
    pub date_of_form_c_nuprc: String,
    pub method_of_cleanup: String,
    pub in_house_contractor: bool,
    pub cleanup_contractor_name: String,
    pub contract_ref_no: String,
    pub cleanup_date_of_mobilization: String,
    pub cleanup_date_of_completion: String,
    pub est_duration_days: f64,
    pub cleanup_cost_ngn_x_1000: f64,
    pub cleanup_cost_us_equiv_x_1000: f64,
    pub loss_due_to_oil_spill_ngn_x_1000: f64,
    pub loss_due_to_oil_spill_us_equiv_x_1000: f64,
    pub downtime_manhours_lost_ngn_x_1000: f64,
    pub downtime_manhours_lost_us_equiv_x_1000: f64,
    pub cleanup_completion_status: String,
    pub any_followup_study: bool,
    pub any_compensation_required: bool,
    pub any_rehabilitation_plan_required: bool,
    pub date_of_final_sampling_once_cleanup_completed: String,
    pub pci_date: String,
    pub is_remadiation_required: bool,
    pub remediation_method: String,
    pub remediation_contractor_name: String,
    pub remediation_contractor_ref_no: String,
    pub remediation_date_of_mobilization: String,
    pub est_date_of_completion: String,
    pub remediation_cost_ngn_x_1000: f64,
    pub remediation_cost_us_equiv_x_1000: f64,
    pub remediation_downtime_manhours_lost_ngn_x_1000: f64,
    pub remediation_downtime_manhours_lost_us_equiv_x_1000: f64,
    pub effective_date_of_remediation_completion: String,
    pub date_of_final_sampling_once_remediation_completed: String,
    pub date_of_close_out_request: String,
    pub date_of_nosdra_certificate: String,
    pub extent_of_contaminated_area: f64,
    pub cost_of_compensation_in_ngn_x_1000: f64,
    pub cost_of_compensation_in_us_equiv_x_1000: f64,
    pub relief: bool,
    pub communities_impacted: String,
    pub a: bool,
    pub b: bool,
    pub cd: bool,
    pub date_of_form_c_nosdra_cleanup: String,
    pub date_of_form_c_nosdra_remediation: String,
    pub cn: bool,
    pub co: bool,
    pub client_id: String,
